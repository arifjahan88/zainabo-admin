...
function SupportIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M40 70c4-10 16-16 20-16s16 6 20 16v36H40V70z"
        fill="#E11D48"
      />
      ...
      <path
        d="M33 38c0-16 12-28 27-28s27 12 27 28"
        fill="none"
        stroke="#64748B"
        strokeWidth="4"
      />
  ...
  return (
    <Card className="overflow-hidden border-0 bg-[#FFF1EB] shadow-none ring-0">
      <CardContent className="relative gap-3 pt-5 pb-4">
        ...
        <SupportIllustration className="pointer-events-none absolute right-1 bottom-0 h-[118px] w-auto" />
      </CardContent>
    </Card>
  );
}

...
const AddProductPage = loadable(
  () => import('@/features/products/pages/add-product-page')
);
const BulkUploadPage = loadable(
  () => import('@/features/products/pages/bulk-upload-page')
);
const DraftsPage = loadable(
  () => import('@/features/products/pages/drafts-page')
);
const PendingPage = loadable(
  () => import('@/features/products/pages/pending-page')
);
const PublishedPage = loadable(
  () => import('@/features/products/pages/published-page')
);
const RejectedPage = loadable(
  () => import('@/features/products/pages/rejected-page')
);
...
const DeliveryPage = loadable(
  () => import('@/features/delivery/pages/delivery-page')
);
const MarketingPage = loadable(
  () => import('@/features/marketing/pages/marketing-page')
);
...
const FinancePage = loadable(
  () => import('@/features/finance/pages/finance-page')
);
...
const SupportPage = loadable(
  () => import('@/features/support/pages/support-page')
);
